...
data modify block ~ ~ ~ front_text.messages[2] set value '{"score":{"name":"初始分數","objective":"menu"},"bold":true,"clickEvent":{"action":"run_command","value":"playsound entity.player.attack.sweep ambient @s"}}'