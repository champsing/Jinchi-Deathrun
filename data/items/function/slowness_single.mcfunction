...
execute if entity @s[team=red] run effect give @r[team=blue, predicate=!items:slowness] slowness 20 0 true
execute if entity @s[team=blue] run effect give @r[team=red, predicate=!items:slowness] slowness 20 0 true
