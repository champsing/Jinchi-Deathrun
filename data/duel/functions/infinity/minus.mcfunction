...
scoreboard players set 減分 score 1000
scoreboard players set 餘數 score 1000

scoreboard players operation 減分 score /= @s teammate
scoreboard players operation @a[tag=minus_score] score -= 減分 score
scoreboard players operation 餘數 score %= @s teammate
