...
execute if entity @n[tag = success_freeze_person] run tellraw @s ["",{"text":">> ","bold":true,"color":"gold"},{"selector":"@n[tag = success_freeze_person]"},{"text":"使用了"},{"text":"凍結道具","color":"gold"},{"selector":""},{"text":"你已被凍結"},{"text":"10秒","color":"gold"}]
execute if entity @n[tag = success_freeze_person] run tellraw @a ["",{"text":">> ","bold":true,"color":"gold"},{"selector":"@n[tag = success_freeze_person]"},{"text":"使用了"},{"text":"凍結道具","color":"gold"},{"selector":"@n[tag = frozen]"},{"text":" 已被凍結"},{"text":"10秒","color":"gold"}]