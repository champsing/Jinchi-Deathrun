...
tellraw @a [{translate: jd.empty},{translate:"jd.console", color: gold},{selector: "@s"},{text: "使用了"},{text: "單人凍結", color: gold},{text: "，"},{selector: "@a[tag = items.freeze_single.target]"},{text: "已被"},{text:"凍結", color: gold},{text: "，無法移動"}]
