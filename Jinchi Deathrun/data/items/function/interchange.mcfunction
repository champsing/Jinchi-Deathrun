...
tag @s add item.interchange
execute if entity @s[team = red] run tag @r[team = red,tag = !item.interchange] add item.interchange.tped
execute if entity @s[team = blue] run tag @r[team = blue,tag = !item.interchange] add item.interchange.tped
