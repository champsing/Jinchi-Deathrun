...
summon item ~ ~ ~ {Item:{id:"minecraft:player_head",components:{item_name:"§b§l250分",lore:[[{"text":"§7獲得250分。"}],[{"text":"§c不受道具冷卻時間限制。"}]],max_stack_size:1,profile:{"properties":[{"name":"textures","value":"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmJkNDRmNTdhZTMxZWFlMmU3NDgyMGYyNjk0MDE5MmMzM2QxMmNhNjNlZmY3MDc5ODM3OWRiNzdlYTlmNDM4MiJ9fX0="}]},custom_data:{"add_score": 250},consumable:{consume_seconds: 999999}}},Tags:["250_point","point_item"]}
summon item ~ ~ ~ {Item:{id:"minecraft:player_head",components:{item_name:"§b§l300分",lore:[[{"text":"§7獲得300分。"}],[{"text":"§c不受道具冷卻時間限制。"}]],max_stack_size:1,profile:{"properties":[{"name":"textures","value":"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOGNjNDk2YTM4ZDM0OGQxMTc4Y2IwYTE2NGU5ZmFkNGRlMzI1OTgxYmNiMGY0ZDRhNmZiZmEwNzY2M2ZmZmJlMSJ9fX0="}]},custom_data:{"add_score": 300},consumable:{consume_seconds: 999999}}},Tags:["300_point","point_item"]}
