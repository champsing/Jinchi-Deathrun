...
execute store result score 生成寶箱 gamecore run scoreboard players get 寶箱點一半 gamecore 
execute store result score 生成寶箱 gamecore run scoreboard players operation 生成寶箱 gamecore -= 現存寶箱 gamecore
