...
tellraw @s ["",{"text":">> ","color":"gold"},{"text":"你已經成功奪取"},{"selector":"@a[tag=robbed]","color": "gold", "bold": true},{"text":"50點體力"}]
tellraw @a[tag=robbed] ["",{"text":">> ","color":"gold"},{"selector":"@s","color":"gold"},{"text":"對你使用了"},{"text":"體力奪取","color": "gold", "bold": true},{"text":"奪取了你"},{"text":" 50 點體力","color": "gold", "bold": true}]
