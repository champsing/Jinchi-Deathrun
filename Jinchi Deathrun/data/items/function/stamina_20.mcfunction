...
tellraw @s [{translate: jd.empty},{translate:"jd.console",color:gold},{translate:jd.items.function.stamina_100.10_1},{translate:jd.items.function.stamina_20.10_2,color:gold}]
