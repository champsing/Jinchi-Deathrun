...
tellraw @a[tag = items.remove_invalid.removed] ["",{"text":">> ","color":"gold"},{"selector":"@s","color":"gold"},{"text":"對你使用了"},{"text":"移除無效狀態","color": "gold", "bold": true},{"text":"使你"},{"text":"的無效狀態解除","color": "gold", "bold": true}]
