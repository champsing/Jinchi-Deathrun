...
tellraw @s[tag = border] [{translate: jd.empty},{translate:"jd.console",color:gold},{translate:jd.game.function.border.16_1},{translate:jd.game.function.border.16_2,color:gold}]
kill @s[tag = border]
