...
#---人數不足---
execute unless score 紅隊人數 menu matches 1.. run return run tellraw @s ["",{text:">> ",color:gold},{text:"玩家人數不足。需要紅隊和藍隊"},{text:"各有一名玩家",bold:true,color:gold},{text:"才能開始遊戲。"}]
execute unless score 藍隊人數 menu matches 1.. run return run tellraw @s ["",{text:">> ",color:gold},{text:"玩家人數不足。需要紅隊和藍隊"},{text:"各有一名玩家",bold:true,color:gold},{text:"才能開始遊戲。"}]
