...
scoreboard players operation 個人貢獻最高分 top_contribution > @a[team = !spec] total_contribution
...
scoreboard players operation @a[team = !spec] top_contribution -= 個人貢獻最高分 top_contribution
...
# 大富豪家: @a[scores = {top_contribution = 0}]  (@a[scores = {top_contribution = 0}] total_contribution)
