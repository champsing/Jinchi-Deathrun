...
tellraw @a [{text:"大富豪家: ",color:aqua,hover_event:{action:"show_text", value:"個人加分最多的玩家。"}},{selector:"@a[scores = {top_score = 0}]"},{text:" (",color:aqua},{score:{name:"@a[scores = {top_score = 0}]",objective:score},color:aqua},{text:")",color:aqua}]
