...
execute at @n[type = armor_stand, tag = red_base] run summon interaction ~ ~3 ~ {Tags: ["red_base", "base"]}
execute at @n[type = armor_stand, tag = blue_base] run summon interaction ~ ~3 ~ {Tags: ["blue_base", "base"]}
