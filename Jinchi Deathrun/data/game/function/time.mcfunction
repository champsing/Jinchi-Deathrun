...
execute unless score 延長賽 gamecore matches 1 unless score 勝負已分 gamecore matches 1 run bossbar set countdown name [{translate:jd.game.function.time.26_1},{score:{name: "剩餘時間",objective: "gamecore"},color: gold},{translate:jd.game.function.time.26_2}]
