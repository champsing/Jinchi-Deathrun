...
summon minecraft:text_display ~ ~ ~ {UUID:[I;1364020769,-626964776,-2141449535,653739147],Tags:["settings"],text:'{"text":"初始分數","color": "green"}',Rotation:[270f,0f]}
summon minecraft:text_display ~ ~ ~ {UUID:[I;1332962679,1122977120,-2086241209,-509829320],Tags:["settings"],text:'{"score":{"name":"初始分數","objective":"menu"}}',Rotation:[270f,0f]}
summon minecraft:interaction ~ ~ ~ {UUID:[I;-1746957356,-1525202357,-2030236345,1882179304],Tags:["settings"],Rotation:[270f,0f]}
...
summon minecraft:text_display ~ ~ ~ {UUID:[I;778190456,2072203004,-1923121719,-1150778636],Tags:["settings"],text:'{"text":"目標分數","color": "green"}',Rotation:[270f,0f]}
summon minecraft:text_display ~ ~ ~ {UUID:[I;1286991773,785927646,-2101045504,615177355],Tags:["settings"],text:'{"score":{"name":"目標分數","objective":"menu"}}',Rotation:[270f,0f]}
summon minecraft:interaction ~ ~ ~ {UUID:[I;425328237,-865777023,-2064810230,-716550501],Tags:["settings"],Rotation:[270f,0f]}
