...
summon text_display ~ ~ ~ {UUID:[I;1364020769,-626964776,-2141449535,653739147],Tags:["settings"],text:'{"text":"初始分數","color": "green"}',Rotation:[270f,0f]}
summon text_display ~ ~ ~ {UUID:[I;1332962679,1122977120,-2086241209,-509829320],Tags:["settings"],text:'{"score":{"name":"初始分數","objective":"menu"}}',Rotation:[270f,0f]}
...
summon text_display ~ ~ ~ {UUID:[I;778190456,2072203004,-1923121719,-1150778636],Tags:["settings"],text:'{"text":"目標分數","color": "green"}',Rotation:[270f,0f]}
summon text_display ~ ~ ~ {UUID:[I;1286991773,785927646,-2101045504,615177355],Tags:["settings"],text:'{"score":{"name":"目標分數","objective":"menu"}}',Rotation:[270f,0f]}
...
summon text_display ~ ~ ~ {UUID:[I;537041449,22823193,-2002285349,1468324250],Tags:["settings"],text:'[{"text":"隨機","bold":true,"color":"red"},{"text":"分隊","bold":true,"color":"blue"}]',Rotation:[270f,0f]}
summon text_display ~ ~ ~ {UUID:[I;1533844994,1313555644,-1304363711,-1641951009],Tags:["settings"],text:'{"text":"左鍵分隊"}',Rotation:[270f,0f]}
...
summon text_display ~ ~ ~ {UUID:[I;1408119967,300829746,-1476614486,-850031730],Tags:["settings"],text:'{"text":"加入旁觀","bold":true,"color": "#c6c6c6"}',Rotation:[270f,0f]}
summon text_display ~ ~ ~ {UUID:[I;-2131794646,216810234,-1956454417,683366146],Tags:["settings"],text:'{"text":"左鍵旁觀，右鍵離開"}',Rotation:[270f,0f]}
