#---不是大廳模式---
execute if score 操作模式 system matches 1 run return run tellraw @s [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"您目前處於編輯模式。請退出"},{text:"編輯模式",bold:true,color:gold},{text:"後再加入隊伍。"}]
execute if score 操作模式 system matches 3 run return run tellraw @s [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"遊戲目前已經開始。請"},{text:"結束遊戲",bold:true,color:gold},{text:"後再加入隊伍。"}]
...
#---已經是該隊了---
execute if entity @s[advancements = {settings:interact/join = true}, team = blue] run tellraw @s [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"您已經加入"},{text:"藍隊", color: blue},{text:"了。"}]
...
execute if entity @s[advancements = {settings:attack/join = true}, team = red] run tellraw @s [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"您已經加入"},{text:"紅隊", color: red},{text:"了。"}]
