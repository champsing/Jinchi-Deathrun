...
# refer to VN.txt
data merge storage start:version_info {verInt: 1, verFloat: "1.0.0", date: "2025/9/21"}
...
tellraw @a ["",{text: ">> ",color:gold},{text: "版本發布頁面\n",color:aqua,bold: true, underlined: true, click_event: {action: "open_url", "url": "https://github.com/champsing/Jinchi-Deathrun/releases/"}}]
