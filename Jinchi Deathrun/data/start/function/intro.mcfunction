...
tellraw @a[gamemode = creative] ["",{text:">> ",color:gold},"若想解除安裝資料包，請點擊 ",{text:"此處",color:gold, hover_event: {action: "show_text", value: "/function start:uninstall"}, click_event: {action: "run_command", command: "/function start:uninstall/mode"}}]
