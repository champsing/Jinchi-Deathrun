...
tellraw @a ["",{"text": ">> ","color":"gold"},{"text": "版本發布頁面","color":"aqua","bold": true, "underlined": true, "clickEvent": {"action": "open_url", "value": "https://github.com/champsing/Jinchi-Deathrun/releases/"}}]