#---保險起見，如果陣地無敵直接return---
execute if entity @e[tag=red_base,limit=1,nbt={Invulnerable:1b}] run return fail
execute if entity @e[tag=blue_base,limit=1,nbt={Invulnerable:1b}] run return fail
