...
#---保險起見---
execute if entity @s[team = red, tag = base_attack_blue] if entity @n[tag = blue_base, tag = invulnerable] run return run function base:invulnerable
execute if entity @s[team = blue, tag = base_attack_red] if entity @n[tag = red_base, tag = invulnerable] run return run function base:invulnerable
