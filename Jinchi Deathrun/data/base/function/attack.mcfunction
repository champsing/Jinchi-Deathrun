...
#---攻擊自己陣地---
execute if entity @s[team=red] as @a[tag=base_attack,team=red] run return run function base:friendly_fire
execute if entity @s[team=blue] as @a[tag=base_attack,team=blue] run return run function base:friendly_fire
