...
execute store result score 紅隊陣地 menu if entity @e[tag = red_base, tag = edit_amst]
execute store result score 藍隊陣地 menu if entity @e[tag = blue_base, tag = edit_amst]
