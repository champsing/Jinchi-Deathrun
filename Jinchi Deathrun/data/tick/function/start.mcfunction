...
#---體力---
execute unless score 準備階段 gamecore matches 1 as @a[team=!spec] if predicate stamina:adrenaline run attribute @s movement_speed modifier add adrenaline 2 add_multiplied_base
