...
#---準備階段---
#---actionbar：預告進場個人分數---
execute if score 準備階段 gamecore matches 1 as @a[team = !spec] run title @s actionbar [{translate:jd.tick.function.start.17_1,bold:true,color:aqua},{score:{name:"@s",objective:score}}]
#---把跑去對方家10格內的傳回去
