...
execute as @e[type = armor_stand, tag = A_point] run data merge entity @s {Glowing:0b,CustomNameVisible:0b,Marker:1b}
execute as @e[type = armor_stand, tag = B_point] run data merge entity @s {Glowing:0b,CustomNameVisible:0b,Marker:1b}
