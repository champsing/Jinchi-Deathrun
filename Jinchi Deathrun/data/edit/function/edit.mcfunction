...
tellraw @a [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"已進入編輯模式"}]
tellraw @a [{translate: jd.empty},{translate:"jd.console",color:gold},{text:"[ 使用教學? ]", color: aqua, underlined: true, click_event:{action: "open_url", url: "https://www.youtube.com/watch?v=RLFXnIPJuZY"}}]
