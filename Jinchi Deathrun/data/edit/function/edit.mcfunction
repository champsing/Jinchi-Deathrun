...
execute as @e[type = armor_stand, tag = A_point] run data merge entity @s {Glowing:1b,CustomNameVisible:1b,Marker:0b,Invisible:0b}
execute as @e[type = armor_stand, tag = B_point] run data merge entity @s {Glowing:1b,CustomNameVisible:1b,Marker:0b,Invisible:0b}
function edit:give
