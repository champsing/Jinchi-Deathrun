...
execute unless entity @n[type = armor_stand, tag = A_point] run return run tellraw @s [{translate: jd.empty},{translate:"jd.console",color: gold},{text:"無法傳送",color: red},{text:", 請先指定"},{translate: "edit.function.border.set_a.0",color:gold}]
