...
execute unless entity @n[type = armor_stand, tag = A_point] run return run tellraw @s [{translate: jd.empty},{translate:"jd.console",color: gold},{translate:jd.edit.function.border.teleport_a.4_1,color: red},{translate:jd.edit.function.delete.5_2},{translate: "jd.edit.function.border.set_a.0",color:gold}]
