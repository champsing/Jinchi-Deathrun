...
execute at @s run summon armor_stand ~ ~ ~ {DisabledSlots: 16191,Tags:['red_base','edit_amst'],CustomName:[{text:"紅隊陣地",color: red}],Team: red,CustomNameVisible: true, Glowing: true, NoGravity: true, NoBasePlate: true}
function edit:align
