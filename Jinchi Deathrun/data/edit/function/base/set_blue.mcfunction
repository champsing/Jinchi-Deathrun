...
execute at @s run summon armor_stand ~ ~ ~ {DisabledSlots: 16191,Tags:['blue_base','edit_amst'],Team: blue_base,CustomName:[{translate: "jd.edit.function.base.set_blue.1",color: blue}],CustomNameVisible: true, Glowing: true, NoGravity: true, NoBasePlate: true}
function edit:align
