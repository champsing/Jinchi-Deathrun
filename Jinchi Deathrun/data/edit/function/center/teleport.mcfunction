...
execute unless entity @n[type = armor_stand, tag = center, tag = edit_amst] run return run tellraw @s ["",{text:">> ",color: gold},{text:"無法傳送",color: red},{text:", 請先指定"},{text:"中央點",color:gold}]
