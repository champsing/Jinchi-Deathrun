...
execute unless entity @n[type = armor_stand, tag = center, tag = edit_amst] run return run tellraw @s ["",{text:">> ",color: gold},{text:"無法傳送",color: red},{text:", 請先指定"},{translate: "edit.function.center.set.0",color:gold}]
